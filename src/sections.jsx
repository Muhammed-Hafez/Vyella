    ...
    <section className="press" id="press">
      <div className="wrap press__inner">
        ...
        <div className="press__row">
          {p.outlets.map((o, i) => (
            <span className="press__outlet" key={i}>
              {t(o, lang)}
            </span>
          ))}
        </div>
        ...
        <div className="contact__grid">
          <div className="contact__cards">
            ...
            <div className="c-card">
              ...
              {c.hours.map((h, i) => (
                <div className="c-card__hours" key={i}>
                  <span>{t(h.d, lang)}</span>
                  <span>{t(h.t, lang)}</span>
                </div>
              ))}
            </div>
            <div className="c-card">
            ...
            <div className="c-card">
              ...
              <a
                className="c-card__big c-card__email"
                href={`mailto:${c.email}`}
              >
                {c.email}
              </a>
              <div className="c-card__label" style={{ marginTop: 14 }}>
                {t(c.socialLabel, lang)}
              </div>
    ...
    <footer className="footer">
      <div className="wrap footer__top">
        <div className="footer__brand">
          <div className="footer__logo">
            <img
              ...
              src="assets/vyella-logo-cream.png"
              alt="Vyella"
            />
          </div>
        ...
        <div className="footer__col">
          ...
          <a href={`tel:${c.phone.replace(/\s/g, "")}`} dir="ltr">
            {c.phone}
          </a>
