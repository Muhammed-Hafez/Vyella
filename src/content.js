  ...
  products: [
    {
      ...
      notes: {
        top: { en: "Raspberry", ar: "توت" },
        heart: { en: "Vanilla Cream", ar: "كريمة فانيليا" },
        base: { en: "Buttery Pastry", ar: "عجينة بالزبدة" },
      },
    },
    {
      id: "loaded-cookie",
      ...
      notes: {
        top: { en: "Milk Chocolate", ar: "شيكولاتة بالحليب" },
        heart: { en: "Cookie Dough", ar: "عجينة كوكيز" },
        base: { en: "Toasted Vanilla", ar: "فانيليا محمّصة" },
      },
    },
    {
      ...
      notes: {
        top: { en: "strawberry", ar: "فراولة" },
        heart: { en: "Cream Cheese", ar: "كريم تشيز" },
        base: { en: "Biscuit Crust", ar: "قاعدة بسكوت" },
      },
    },
    {
      id: "guava-sorbet",
      ...
      notes: {
        top: { en: "Lime Zest", ar: "قشر ليمون" },
        heart: { en: "Pink Guava", ar: "جوافة وردي" },
        base: { en: "Shortcake", ar: "شورت كيك" },
      },
    },
    {
      ...
      notes: {
        top: { en: "Blueberry", ar: "بلوبيري" },
        heart: { en: "Maple Cream", ar: "كريمة ميبل" },
        base: { en: "Brioche", ar: "بريوش" },
      },
    },
    {
      id: "chocolate-waffle",
      ...
      notes: {
        top: { en: "Blueberry", ar: "بلوبيري" },
        heart: { en: "Whipped Cream", ar: "كريمة" },
        base: { en: "Cocoa Waffle", ar: "وافل كاكاو" },
      },
    },
    {
      id: "tiramisu-parfait",
      ...
      notes: {
        top: { en: "Raspberry", ar: "توت" },
        heart: { en: "Espresso Cream", ar: "كريمة إسبريسو" },
        base: { en: "Cocoa Sponge", ar: "كيك كاكاو" },
      },
    },
    {
      id: "strawberry-cake",
      ...
      notes: {
        top: { en: "Strawberry", ar: "فراولة" },
        heart: { en: "Vanilla Sponge", ar: "كيك فانيليا" },
        base: { en: "Shortcrust", ar: "عجينة هشة" },
      },
    },
    {
      ...
      notes: {
        top: { en: "Caramel Biscuit", ar: "بسكوت كراميل" },
        heart: { en: "Cheesecake", ar: "تشيز كيك" },
        base: { en: "Cocoa Crunch", ar: "كرانش كاكاو" },
      },
    },
    {
      id: "ube-parfait",
      ...
      notes: {
        top: { en: "Ube Jam", ar: "مربى أوبي" },
        heart: { en: "Coconut Cream", ar: "كريمة جوز هند" },
        base: { en: "Sweet Rice", ar: "أرز حلو" },
      },
    },
    {
      id: "iced-coffee",
      ...
      notes: {
        top: { en: "Cold Brew", ar: "كولد برو" },
        heart: { en: "Vanilla", ar: "فانيليا" },
        base: { en: "Sweet Cream", ar: "كريمة حلوة" },
      },
    },
    {
      id: "matcha",
      ...
      notes: {
        top: { en: "Matcha", ar: "ماتشا" },
        heart: { en: "Vanilla", ar: "فانيليا" },
        base: { en: "Steamed Milk", ar: "حليب مبخّر" },
      },
    },
  ],
